...
<img src="https://capsule-render.vercel.app/api?type=venom&height=200&text=shruti-su&fontSize=70&color=0:0f0c29,50:302b63,100:24243e&fontColor=A9FEF7&animation=fadeIn&stroke=534AB7&strokeWidth=2" width="100%"/>
...
│                                                         │
│   Every framework I write, every kernel I compile,      │
│   every network tool I craft is a statement:            │
│   understanding goes all the way down.                  │
│                                                         │
└─────────────────────────────────────────────────────────┘
```
...
**Open to:** `Collaboration` · `Open Source` · `Consulting` · `Technical Writing`
...
```bash
$ uptime
  🔧  Configured Linux servers faster than most can boot Windows
  🧠  Debugged production issues at 3 AM — while asleep
  ☕  Primary fuel: Coffee | Backup fuel: More coffee
  🌙  Night coder — peak performance: 11 PM to 4 AM
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f0c29,50:302b63,100:24243e&height=120&section=footer&text=Keep+building.+Keep+breaking.+Keep+shipping.&fontSize=14&fontColor=A9FEF7&animation=fadeIn&fontAlignY=65" width="100%"/>
